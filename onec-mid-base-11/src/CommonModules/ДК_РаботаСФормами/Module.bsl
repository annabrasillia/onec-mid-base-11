...
//добавление пересчета
Процедура ДобавитьКнопкуВГруппаШапкаПраво(Форма)
	
	Команда = Форма.Команды.Добавить("ДК_ПересчитатьСумму");
	Команда.Действие = "ДК_ПересчитатьСуммуПосле";
	Команда.Заголовок = "Пересчитать сумму";
	Кнопка = Форма.Элементы.Добавить("ДК_ПересчитатьСумму", Тип("КнопкаФормы"), Форма.Элементы.ГруппаШапкаПраво);
	Кнопка.ИмяКоманды = "ДК_ПересчитатьСумму";
